...
## 🛡️ CI/CD, traçabilité et sauvegarde

- À chaque push sur `main`, le code, les règles Firestore et les index sont sauvegardés automatiquement (artefact zip) et déployés.
