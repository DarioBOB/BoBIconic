...
@Component({
  ...
  template: `
    <ion-header>
      <app-user-status-bar title="PAGES.NOTIFICATIONS.TITLE"></app-user-status-bar>
    </ion-header>
    <ion-content id="main-content" class="ion-padding notifications-placeholder">
      <div class="placeholder-container">
        <ion-icon name="notifications" class="placeholder-icon"></ion-icon>
