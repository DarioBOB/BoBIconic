...
@Component({
  ...
  template: `
    <ion-header>
      <app-user-status-bar title="PAGES.GAMES.TITLE"></app-user-status-bar>
    </ion-header>
    <ion-content id="main-content" class="ion-padding games-placeholder">
      <div *ngIf="isLoading" class="spinner-container">
        <ion-spinner name="crescent"></ion-spinner>
        <div>Chargement des jeux…</div>
      </div>
      <div class="placeholder-container" *ngIf="!isLoading">
        <ion-icon name="game-controller-outline" class="placeholder-icon"></ion-icon>
